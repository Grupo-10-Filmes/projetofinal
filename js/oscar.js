...
const primeiroFilme = fetch(
  "http://www.omdbapi.com/?t=All+Quiet+on+the+Western+Front&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const segundoFilme = fetch(
  "https://www.omdbapi.com/?t=avatar+The+Way+of+Water&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const terceiroFilme = fetch(
  "http://www.omdbapi.com/?t=banshees+of+inisherin&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const quintoFilme = fetch(
  "http://www.omdbapi.com/?t=The+Fabelmans&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const sextoFilme = fetch(
  "http://www.omdbapi.com/?t=t%C3%A1r&y=2022&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const setimoFilme = fetch(
  "http://www.omdbapi.com/?t=maverick&y=2022&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const oitavoFilme = fetch(
  "http://www.omdbapi.com/?t=Sadness&y=2022&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
...
const nonoFilme = fetch(
  "http://www.omdbapi.com/?t=women&y=2022&apikey=16d07928"
)
  .then((response) => {
    return response.json();
  })
